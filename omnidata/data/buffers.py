...
from ..features import DeviceContainer
...
class AbstractCountableData(AbstractData):
	...
	class UnknownCount(AbstractBuffer.NotReady):
		def __init__(self):
...
class AbstractCountableDataView(AbstractCountableData, AbstractView):
...
class AbstractFixedBuffer(AbstractCountableData, AbstractBuffer): # fixed number of samples (possibly not known until after loading)
